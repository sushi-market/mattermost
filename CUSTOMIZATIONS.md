...
| 2026-04-27 | Верхняя панель веб-приложения | `webapp/channels/src/components/global_header/right_controls/right_controls.tsx` | Добавлена компактная пунктирная кнопка «Скачать приложение» слева от значка упоминаний, открывающая `https://mattermost.datafood.tech/` в новой вкладке. |
