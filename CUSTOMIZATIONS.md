...
| 2026-04-27 | Верхняя панель веб-приложения | `webapp/channels/src/components/global_header/right_controls/right_controls.tsx` | Кнопка «Скачать приложение» получила иконку загрузки, менее плотный фон, тонкую рамку, более заметный hover и icon-only режим на узких экранах. |
...
| 2026-04-27 | Поддержка форка | `webapp/channels/src/components/global_header/left_controls/product_menu/product_menu_list/*`, `webapp/channels/src/components/mobile_sidebar_right/mobile_sidebar_right_items/*` | Удалены остатки скрытого пункта «О ...»: неиспользуемый `siteName`, закомментированный JSX и устаревшие snapshots. |
| 2026-04-27 | Переводы веб-приложения | `webapp/channels/src/i18n/ru.json`, `webapp/channels/src/utils/constants.tsx`, `webapp/channels/src/components/new_search/search_hint.tsx`, `webapp/channels/src/components/search_hint/search_hint.tsx` | Переведены placeholder, строка подсказки и видимые подписи фильтров в верхнем окне поиска; вставляемые поисковые операторы Mattermost оставлены в оригинальном синтаксисе. |
